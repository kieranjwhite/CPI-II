...
public abstract class AbstractComboExpander<I,O> {
	 ...
	 * @param pExpansions One permutation of outputs. Each element in pExpansions corresponds to 
	 * its respective element which was passed to the <code>expand</code> method. So pExpansions.get(3) 
	 * is one of the values pTerms[3] was mapped to in the pOrig2Expansions constructor argument, 
	 * assuming that there were at least 3 elements in pTerms.  
	 */
