 ...
 * &lt;/fieldType&gt;</pre>
 */
public class LatinLowerCaseFilterFactory extends TokenFilterFactory implements MultiTermAwareComponent {

  /** Creates a new IrishLowerCaseFilterFactory */
  public LatinLowerCaseFilterFactory(Map<String,String> args) {
    super(args);
    if (!args.isEmpty()) {
