...
package com.hourglassapps.cpi_ii.stem.lucene;
 ...
 */
public abstract class AbstractStempelFilter extends TokenFilter {
   ...
   */
  public AbstractStempelFilter(TokenStream in, StempelStemmer stemmer) {
   ...
   */
  public AbstractStempelFilter(TokenStream in, StempelStemmer stemmer, int minLength) {
    super(in);
