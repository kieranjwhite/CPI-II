...
public abstract class AbstractDisjunctionRelayer extends ConcreteThrower<Exception> implements ExpansionReceiver<String> {
	private final static String TAG=AbstractDisjunctionRelayer.class.getName();
	private List<List<String>> mDisjunctions=new ArrayList<List<String>>();
	private Query<URI> mQ;	
	private DataOutputStream mOut;
	
	public AbstractDisjunctionRelayer(Query<URI> pQ) throws IOException {
		mQ=pQ;
