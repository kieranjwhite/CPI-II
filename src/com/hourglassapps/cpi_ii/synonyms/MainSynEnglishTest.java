...
public class MainSynEnglishTest {
	...
	public static void main(String[] pArgs) throws IOException, ParseException {
		try(Reader reader=new BufferedReader(new InputStreamReader(MainSynEnglishTest.class.getResourceAsStream(WORDNET_SYNONYMS)))) {
