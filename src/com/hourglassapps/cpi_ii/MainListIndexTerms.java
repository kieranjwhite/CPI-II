		...
		try {
			...
			if(stemFile!=null) {
				...
				if("-".equals(stemFile)) {
					...
					in=new BufferedInputStream(new FileInputStream(new File(stemFile)));
				}
				...
				final AbstractComboExpander<String, String> expander=
						new AbstractComboExpander<String, String>(stem2Variants, 
								new IdentityConverter<String>()){
