...
* 7/11/2014 10h00
** Points
*** TODO Be sure of when '_' term are generated by Shingle before submitting full run to Bing
*** TODO Verify that the longest queries are accepted by Bing before doing full run
...
*** TODO why is the serialised stem group file different for unigrams, bigrams and trigrams
